...
const proc = Bun.spawnSync(['bun', 'scripts/check-publisher-external-ig.ts'], {
  ...
  env: {
    ...Bun.env,
    PUBLISHER_IG_LABEL: Bun.env.PUBLISHER_IG_LABEL || 'crd',
    PUBLISHER_IG_REPO: Bun.env.PUBLISHER_IG_REPO || 'https://github.com/HL7/davinci-crd.git',
    PUBLISHER_IG_REF: Bun.env.PUBLISHER_IG_REF || 'master',
    PUBLISHER_IG_DIR: Bun.env.PUBLISHER_IG_DIR || 'temp/crd-ig',
