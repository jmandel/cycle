...
// <viewer>/index.html#shlink:/<payload>. Override VIEWER_BASE when publishing
...
await Bun.write(`${dir}/_shlink-local-ig.txt`, share("http://localhost:5525/viewer/index.html", localFileUrl) + "\n");
