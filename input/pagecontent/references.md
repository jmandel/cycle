...
- [Observation](https://hl7.org/fhir/R4/observation.html) — granular facts, `hasMember`, and coded/text results
...
- [Provenance](https://hl7.org/fhir/R4/provenance.html) — source-to-normalized transformation record
...
The terminology validation included with this source kit checks the referenced LOINC and SNOMED CT codes against the supplied licensed distributions. Implementers remain responsible for the terminology editions and licenses applicable to their deployments.
